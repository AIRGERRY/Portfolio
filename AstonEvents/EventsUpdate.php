    ...
    <div class="jumbotron">
        <div class="container" id="eventsupdate">
                ...
                <h2>Update Event Form</h2>
                    <h4>Note: Event Organiser can only update their own organised events not others!</h4>
                    <h4>Note: All input fields must be filled in!</h4>
                    <h4>Note: Refresh page to update the table.</h4>
