...
<div class="jumbotron" >
    <h1>All Organised Culture Events at Aston!</h1>
    <div class="container" id="table">
        <table id="myTable" border="0">
            ...
            <tr>
                ...
                <th> Description </th>
                <th> Event Time </a></th>
                <th><a href="ListCultureEvents.php?sorting=<?php echo $sort;?>&field=<?php echo 'organiser_name';?>"> Organiser Name</th>
                <th><a href="ListCultureEvents.php?sorting=<?php echo $sort;?>&field=<?php echo 'event_date';?>"> Event Date </th>
                <th> Location</th>
                <th> Likes </th>
                <th> Information </th>
            </tr>
            ...
            <?php
            include("connect.php");
            $sql = ("SELECT * FROM events WHERE category = 'Culture' ORDER BY $field $sort");
                ...
                <tr class="record">
                    <form action="ExtraContent.php" method="post">
                        ...
                        <td><?php echo $row['like_ranking'];?>
                            <a href="ListCultureEvents.php?like_id=<?php echo $row['id'];?>" id="likebtn" name="like_btn">Like</a></td>
    ...
    if(isset($_GET['like_id'])) {
        ...
        $result = $db->prepare($sql);
        $result->execute();
        header("Location: ListCultureEvents.php");
    }
    ?>
</body>
</html>
